...
public static class IFriendsListService
{
    ...
    {
        var request = new GetRequest(SteamApiUrls.IFriendsListService_GetFavorites_v1)
        {
    ...
    {
        var request = new GetRequest(SteamApiUrls.IFriendsListService_GetFriendsList_v1)
        {
            Proxy = apiRequest.Proxy,
            CancellationToken = apiRequest.CancellationToken,
            UserAgent = KnownUserAgents.OkHttp,
