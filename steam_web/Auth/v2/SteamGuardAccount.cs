...
{
    [ProtoMember(2)] public string revocation_code { get; set; }
    /// <summary>
    /// Reason the authenticator is being removed
    /// </summary>
    [ProtoMember(5)] public uint revocation_reason { get; set; }
    /// <summary>
    /// Type of Steam Guard to use once token is removed
    /// </summary>
    [ProtoMember(6)] public uint steamguard_scheme { get; set; }
    /// <summary>
    /// Remove all steamguard cookies
    /// </summary>
    //[ProtoMember(7)] public bool remove_all_steamguard_cookies { get; set; } = true;
}
[ProtoContract]
