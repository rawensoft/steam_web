...
class AuthSessionMobileRequest
{
	...
	/// </summary>
	[ProtoMember(8)] public string website_id
    {
        get
        {
            if (wesiteid != null)
    ...
    [ProtoMember(9)] public CAuthentication_DeviceDetails_Mobile device_details { get; init; } = new();
    [ProtoMember(11)] public int language { get; init; } = 0;
}