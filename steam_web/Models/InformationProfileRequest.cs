...
public class InformationProfileRequest
{
    private readonly SessionData _session;
    public string weblink_1_title { get; init; } = string.Empty;
    public string weblink_1_url { get; init; } = string.Empty;
    public string weblink_2_title { get; init; } = string.Empty;
    public string weblink_2_url { get; init; } = string.Empty;
    public string weblink_3_title { get; init; } = string.Empty;
    public string weblink_3_url { get; init; } = string.Empty;
