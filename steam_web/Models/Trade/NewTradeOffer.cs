...
public class NewTradeOffer
{
    ...
    public class New
    {
        ...
        public void AddAssets(uint appid, ulong contextid, ulong assetid, uint amount = 1) => Assets.Add(new NewAssets(appid, contextid, assetid, amount));
    }
    public class NewAssets
    {
        ...
        public NewAssets(uint AppId, ulong ContextId, ulong AssetId, uint Amount = 1)
        {
            this.AppId = AppId;
